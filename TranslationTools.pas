...
begin
  if Assigned(ResStringRec) then
    Result:=TranslationManager.GetResourceString(ResStringRec);
end;
...
function TTranslationManager.GetResourceString(ResStringRec: PResStringRec): string;
begin
  Result:=Translations[ResStringRec^.Identifier-ResourceStringOffset];
end;
