...
uses Windows, SysUtils, Contnrs, MathUtils, Graphics, DiagramBase,
...
function TBitmapObject.CreateCopy: TBaseObject;
begin
...
function TMetafileObject.CreateCopy: TBaseObject;
begin
  Result:=TMetafileObject.Create;
  Result.Assign(Self);
end;
  ...
  begin
    ...
    begin
      ...
      try
        ...
        Inc(LocalCanvasInfo.Offset.X,Round(Position.Left*CanvasInfo.Scale.X));
        Inc(LocalCanvasInfo.Offset.Y,Round(Position.Top*CanvasInfo.Scale.Y));
