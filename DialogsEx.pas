...
uses
  Windows, Messages, SysUtils, Classes, Graphics, Controls, Forms, Dialogs, CommDlg, stdctrls,
  ExtCtrls, LinarBitmap, SyncObjs, Math, PanelFrame, BitmapResize
...
uses ExtDlgs, BitmapGammaInterpolation; // To get DLGTEMPLATE resource
//{$R DialogsEx.res}
...
begin
  if Assigned(OnLoaded) and (LoadedFileName=WantedFileName) then OnLoaded(Self,Image,Msg);
end;
