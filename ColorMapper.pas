...
type
  ...
  THistogram = object
                 ...
                 procedure Append(Image: TLinearBitmap; Plane: Integer=AllPlanes);
...
procedure AdjustSaturation(Image: TLinearBitmap; Saturation: Double; Result: TLinearBitmap);
...
begin
  ...
  SetBrightnessContrastCurve(Brightness,Contrast,Courve);
end;
...
begin
  ...
  begin
    Curve[0].X:=-Max(0,Brightness);
    Curve[1].X:=ContrastHeight+ExtraContrastStart-Brightness;
    Curve[2].X:=127-Brightness;
    Curve[3].X:=255-ContrastHeight-ExtraContrastStart-Brightness;
    Curve[4].X:=255-Min(0,Brightness);
  ...
  begin
    Curve[0].X:=-Max(0,Brightness);
    Curve[1].X:=ContrastHeight+Contrast-Brightness;
    Curve[2].X:=127-Brightness;
    Curve[3].X:=255-ContrastHeight-Contrast-Brightness;
    Curve[4].X:=255-Min(0,Brightness);
  ...
  begin
    Curve[0].X:=-Max(1,Brightness-Contrast);
    Curve[1].X:=ContrastHeight+Contrast-Brightness;
    Curve[2].X:=127-Brightness;
    Curve[3].X:=255-ContrastHeight-Contrast-Brightness;
    Curve[4].X:=256-Min(0,Brightness+Contrast);
