...
uses Windows, Classes, Monitor, SysUtils, LinarBitmap, Streams, BufStream, Graphics, DelphiStream, MemUtils,
  CRC32Stream, Deflate, ColorMapper, Math, MemStream, FileMappedBitmap;
