...
type
  ...
  TLinearBitmap = class(TAssignObject)
    ...
    public
      ...
      // Create new image
      procedure New(Width,Height: Integer; PixFormat: TPixelFormat; BytesPerLine: Integer=0);
      ...
      procedure PasteImage(Source: TLinearBitmap; X,Y: Integer; SrcWidth: Integer=MaxInt; SrcHeight: Integer=MaxInt);
...
begin
  Dispose;
  if Other.ClassType=TLinearBitmap then
  begin
    fWidth:=Other.fWidth;
  ...
  begin
    Assert(False,'TakeOver only makes sense for TLinearBitmaps!');
    Assign(Other);
    Other.Dispose;
  end;
end;
