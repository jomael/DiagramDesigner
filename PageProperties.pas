...
uses StringUtils, Math, Printers;
...
begin
  ...
  try
    ...
    begin
      ...
      UnitLabel1.Caption:=RemLeadSpace(DisplayUnitName[DisplayUnits]);
      UnitLabel2.Caption:=RemLeadSpace(DisplayUnitName[DisplayUnits]);
